Module ModuloValidaciones
    ...
    Public Function ValidarEntrada(texto As String, ByRef resultado As Double) As Boolean
        ...
        If String.IsNullOrWhiteSpace(texto) Then
            MostrarError("El campo de monto no puede estar vacío." & vbCrLf &
        ...
        If Not Double.TryParse(textoLimpio,
                               ...
                               resultado) Then
            MostrarError("El valor ingresado no es un número válido." & vbCrLf &
        ...
        If resultado <= 0 Then
            MostrarError("El monto debe ser un número mayor a cero." & vbCrLf &
        ...
        If resultado > 999_999_999_999 Then
            MostrarError("El monto ingresado es demasiado grande." & vbCrLf &
    ...
    Public Function ValidarMonedasDistintas(origen As String, destino As String) As Boolean
        If origen = destino Then
            MostrarError("La moneda origen y destino no pueden ser iguales." & vbCrLf &
